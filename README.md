...
- **pytorch_rccl_reproducer_setup_login_node.sh** : On ouranos/login node (see TARGETDIR for the over-arching  target directory - ~350 GB needed) - To be ran once.
    -- Setup pixi and modify default settings for the reproducer (paths, slurm submission script...) 
